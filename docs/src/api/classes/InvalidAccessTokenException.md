...
[lib/src/exceptions/invalid-access-token.exception.ts:8](https://github.com/joonashak/nestjs-eve-auth/blob/2fa8073/lib/src/exceptions/invalid-access-token.exception.ts#L8)
