...
• **new InvalidAccessTokenException**(): [`InvalidAccessTokenException`](InvalidAccessTokenException.md)
...
[lib/src/exceptions/invalid-access-token.exception.ts:8](https://github.com/joonashak/nestjs-eve-auth/blob/db41b3e/lib/src/exceptions/invalid-access-token.exception.ts#L8)
