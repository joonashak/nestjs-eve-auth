...
[lib/src/exceptions/invalid-esi-id.exception.ts:8](https://github.com/joonashak/nestjs-eve-auth/blob/db41b3e/lib/src/exceptions/invalid-esi-id.exception.ts#L8)
